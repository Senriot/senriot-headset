package com.senriot.headset.web.websocket

import com.senriot.headset.config.WebsocketConfiguration.Companion.IP_ADDRESS
import com.senriot.headset.web.websocket.dto.ActivityDTO
        ...
        ApplicationListener<SessionDisconnectEvent>
{
    ...
    fun sendActivity(
        @Payload activityDTO: ActivityDTO, stompHeaderAccessor: StompHeaderAccessor,
        principal: Principal
    ): ActivityDTO
    {
        activityDTO.apply {
